...
export const addBackgroundBit = (
  ...
  thisRock.position.set(
    count % 2 == 0 ? 60 - Math.random() : -60 - Math.random(),
    0,
    zOffset
  );
  ...
  environmentBits.unshift(thisRock);
};
...
export const addChallengeRow = (
  ...
  challengeRows.unshift({
    rowParent: rowGroup,
    index: sceneConfiguration.challengeRowCount++,
  });
